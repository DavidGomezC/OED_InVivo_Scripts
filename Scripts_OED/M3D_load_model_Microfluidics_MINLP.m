...
model.eqns=...                                                                      % Equations describing system dynamics. Time derivatives are regarded 'd'st_name''
               char('dCit_mrna=alpha1+Vm1*((5*IPTG)^h1/(Km1^h1+(5*IPTG)^h1))-d1*Cit_mrna',...
...
model.par =[0.000377125304442752*60, 0.00738924359598526*60, 1.53333782244337, 5.01927275636639,... 
    0.00118831480244382*60, 0.0461264539194078*60, 0.000475563708997018*60, 0.000301803966012407*60, 68.8669567134881]; % results of the fitting of the reduced model performed using CrossValidation equal on Intuition Driven microfluidics data (multiplication to 60 is to convert units from seconds to minutes)
