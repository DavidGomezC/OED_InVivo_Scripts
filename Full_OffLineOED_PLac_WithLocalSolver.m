...
%% Run OED (Iteration 1)
[oed_res, resultsOED] = Run_DiscreteOED_PLac_WithLocalSolver('Iter1_Try1', 1);

%% Generate input file for the microscope (Iteration 1)
GenerateInputFileMicroscope_WithLocalSolver(oed_res, 1);
...
%% Run OED (Iteration 2)
[oed_res2, resultsOED2] = Run_DiscreteOED_PLac_WithLocalSolver('Iter2_Try1', 2);

%% Generate input file for the microscope (Iteration 2)
GenerateInputFileMicroscope_WithLocalSolver(oed_res2, 2);
...
%% Run OED (Iteration 3)
[oed_res3, resultsOED3] = Run_DiscreteOED_PLac_WithLocalSolver('Iter3_Try1', 3);

%% Generate input file for the microscope (Iteration 3)
GenerateInputFileMicroscope_WithLocalSolver(oed_res3, 3);
