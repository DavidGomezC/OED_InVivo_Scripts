...
function [x,fval,exitflag,numeval]=ssm_localsolver_MINLP(X0,x_L,x_U,c_L,c_U,neq,ndata,int_var,bin_var,fobj,fjac,...
...
pen=ssm_penalty_function_MINLP(x,c,c_L,c_U,tolc);
