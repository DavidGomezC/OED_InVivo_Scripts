...
%    end
    ...
    [val,val_penalty,pena,nlc,include,x] = ssm_evalfc_MINLP2(x,x_L,x_U,fobj,nconst,c_L,c_U,...
	...
	if stage_1==1, stage_1=0; stage_2=1; end
        ...
        child_penalty=[child_penalty;ssm_penalty_function_MINLP(x,child_nlc(k,:),c_L,c_U,tolc)];
        ...
        if not(isempty(local_solutions))
            ...
            %tenemos
            [f,ind]=ssm_isdif2_MINLP(x,local_solutions,1e-2,1);
