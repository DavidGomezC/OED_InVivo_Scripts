...
function  [vector,vector_value,vector_penalty,vector_value_penalty,vector_nlc,...
    new_child,new_child_value,new_child_penalty,new_child_value_penalty,new_child_nlc,nfuneval]=ssm_beyond_MINLP(z1,z2,z2_val,fobj,nrand,tolc,weight,...
...
while continuar
    ...
    %Evaluate
    [val,val_penalty,pena,nlc,include,x] = ssm_evalfc_MINLP2(xnew,x_L,x_U,fobj,nconst,c_L,c_U,...
