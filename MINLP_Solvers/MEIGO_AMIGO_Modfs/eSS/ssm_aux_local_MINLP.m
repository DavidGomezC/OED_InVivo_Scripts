...
function ssm_aux_local_MINLP(fobj,fjac,x_L,x_U,c_L,c_U,neq,local_solver,nvar,varargin)
...
%                fprintf(fid,' };\n');
    ...
    case 'nl2sol'
        ...
        % see if the 
        flag = ess_aux_local_checkfiles_MINLP('objf_nl2sol.m', fobj);
        if flag == 0
        ...
        if ~isempty(fjac)
            flag = ess_aux_local_checkfiles_MINLP('fjac_nl2sol.m', fjac);
            if flag == 0
